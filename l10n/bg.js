OC.L10N.register(
    ...
    "File containing {virus} detected" : "Открит е файл, съдържащ {virus}",
    ...
    "TLS" : "TLS",
    "Use TLS encryption." : "Използвай TLS криптиране.",
    ...
    "Check only first bytes of the file, -1 means no limit" : "Проверява се само първите байтове на файла, -1 означава без ограничение",
