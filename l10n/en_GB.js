OC.L10N.register(
    ...
    "%s. Upload cannot be completed." : "%s. Upload cannot be completed.",
    "Saved" : "Saved",
    ...
    "All rules cleared" : "All rules cleared",
    "Failed to clear rules" : "Failed to clear rules",
    "Rules reset to defaults" : "Rules reset to defaults",
    "Failed to reset rules" : "Failed to reset rules",
    ...
    "Signature to search" : "Signature to search",
    ...
    "File size limit for periodic background scans and chunked uploads in bytes, -1 means no limit" : "File size limit for periodic background scans and chunked uploads in bytes, -1 means no limit",
    "First bytes to scan" : "First bytes to scan",
    "Check only first bytes of the file, -1 means no limit" : "Check only first bytes of the file, -1 means no limit",
    "Maximum stream length" : "Maximum stream length",
    "Reopen socket after this number of bytes." : "Reopen socket after this number of bytes.",
    ...
    "Block unscannable files (such as encrypted archives)" : "Block unscannable files (such as encrypted archives)",
