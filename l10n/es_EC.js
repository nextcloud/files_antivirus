OC.L10N.register(
    ...
    "Antivirus for files is an antivirus app for Nextcloud.\n\n* 🕵️‍♂️ When the user uploads a file, it's checked\n* ☢️ Uploaded and infected files will be deleted and a notification will be shown and/or sent via email\n* 🔎 Background Job to scan all files\n* ❓ Use ClamAV (open source) or Kaspersky Scan Engine\n\nThis application inspects files that are uploaded to Nextcloud for viruses before they are written to the Nextcloud storage. If a file is identified as a virus, it is either logged or not uploaded to the server. The application relies on the underlying ClamAV virus scanning engine, which the admin points Nextcloud to when configuring the application. Alternatively, a Kaspersky Scan Engine can be configured, which has to run on a separate server.\nFor this app to be effective, the ClamAV virus definitions should be kept up to date. Also note that enabling this app will impact system performance as additional processing is required for every upload. More information is available in the Antivirus documentation." : "El Antivirus de archivos es una aplicación de antivirus para Nextcloud.\n\n🕵️‍♂️ Cuando el usuario carga un archivo, este se verifica\n☢️ Los archivos cargados e infectados se eliminarán y se mostrará una notificación y/o se enviará por correo electrónico\n🔎 Trabajo en segundo plano para escanear todos los archivos\n❓ Usa ClamAV (código abierto) o Kaspersky Scan Engine\nEsta aplicación inspecciona los archivos que se cargan en Nextcloud en busca de virus antes de que se escriban en el almacenamiento de Nextcloud. Si se identifica un archivo como virus, se registra o no se carga en el servidor. La aplicación se basa en el motor de escaneo de virus subyacente ClamAV, al que el administrador apunta Nextcloud al configurar la aplicación. Alternativamente, se puede configurar un motor de escaneo Kaspersky, que debe ejecutarse en un servidor separado. Para que esta aplicación sea efectiva, las definiciones de virus de ClamAV deben mantenerse actualizadas. También tenga en cuenta que habilitar esta aplicación afectará el rendimiento del sistema, ya que se requiere un procesamiento adicional para cada carga. Hay más información disponible en la documentación de Antivirus.",
