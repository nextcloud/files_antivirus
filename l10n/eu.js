OC.L10N.register(
    ...
    "Antivirus for files is an antivirus app for Nextcloud.\n\n* 🕵️‍♂️ When the user uploads a file, it's checked\n* ☢️ Uploaded and infected files will be deleted and a notification will be shown and/or sent via email\n* 🔎 Background Job to scan all files\n* ❓ Use ClamAV (open source), Kaspersky Scan Engine or an ICAP compatible scanner\n\nThis application inspects files that are uploaded to Nextcloud for viruses before they are written to the Nextcloud storage. If a file is identified as a virus, it is either logged or not uploaded to the server. The application relies on the underlying ClamAV virus scanning engine, which the admin points Nextcloud to when configuring the application. Alternatively, a Kaspersky Scan Engine can be configured, which has to run on a separate server.\nFor this app to be effective, the ClamAV virus definitions should be kept up to date. Also note that enabling this app will impact system performance as additional processing is required for every upload. More information is available in the Antivirus documentation." : "Fitxategientzako antibirusa Nextcloud-erako birusen aurkako aplikazioa da.\n\n* 🕵️‍♂️ Erabiltzaileak fitxategi bat kargatzen duenean, egiaztatu egiten da\n* ☢️ Kargatutako eta kutsatutako fitxategiak ezabatu egingo dira eta jakinarazpen bat erakutsiko da eta/edo posta elektroniko bidez bidaliko da\n* 🔎 Atzeko planoko lana fitxategi guztiak eskaneatzeko\n* ❓ Erabili ClamAV (kode irekia), Kaspersky Scan Engine edo ICAP eskaner bateragarria\n\nAplikazio honek Nextcloud-era kargatzen diren fitxategiak  birusen bila ikuskatzen ditu, Nextcloud biltegian idatzi aurretik. Fitxategi bat birus gisa identifikatzen bada, edo erregistratzen da edo ez da zerbitzarira igotzen. Aplikazioa oinarritzen da azpian dagoen ClamAV birusen eskaneatzeko motorrean, zeina administratzaileak Nextcloud-i seinalatzen baitio aplikazioa konfiguratzerakoan. Bestela, Kaspersky Scan Engine bat konfigura daiteke, zerbitzari bereizi batean exekutatu behar duena.\nAplikazio hau eraginkorra izan dadin, ClamAV birusaren definizioak eguneratuta egon behar dira. Kontuan izan, gainera, aplikazio hau gaitzeak sistemaren errendimenduan eragina izango duela, karga bakoitzean prozesamendu gehigarria behar baita. Informazio gehiago birusen aurkako dokumentazioan eskuragarri dago.",
