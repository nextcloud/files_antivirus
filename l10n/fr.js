OC.L10N.register(
    ...
    "ClamAV Daemon (Socket)" : "Démon (socket) ClamAV",
    ...
    "ClamAV StreamMaxLength value in bytes." : "StreamMaxLength de ClamAV (en octets).",
    "bytes" : "octets",
    "Path to clamscan" : "Chemin de clamscan",
    "Path to clamscan executable." : "Chemin de l'exécutable clamscan",
    "Not required in Daemon Mode." : "Non requis dans le mode démon.",
