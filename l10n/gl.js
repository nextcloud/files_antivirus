OC.L10N.register(
    ...
    "An antivirus app for Nextcloud based on ClamAV" : "Un aplicativo de antivirus para o Nextcloud bseado no ClamAV",
    "Antivirus for files is an antivirus app for Nextcloud based on ClamAV.\n\n* 🕵️‍♂️ When the user uploads a file, it's checked\n* ☢️ Uploaded and infected files will be deleted and a notification will be shown and/or sent via email\n* 🔎 Background Job to scan all files\n\nThis application inspects files that are uploaded to Nextcloud for viruses before they are written to the Nextcloud storage. If a file is identified as a virus, it is either logged or not uploaded to the server. The application relies on the underlying ClamAV virus scanning engine, which the admin points Nextcloud to when configuring the application.\nFor this app to be effective, the ClamAV virus definitions should be kept up to date. Also note that enabling this app will impact system performance as additional processing is required for every upload. More information is available in the Antivirus documentation." : "Antivirus para ficheiros é un aplicativo antivirus para Nextcloud baseado no ClamAV.\n\n* 🕵️♂️ Cando o usuario envía un ficheiro, este comprobase\n* ☢️ Os ficheiros enviados e infectados eliminaranse e amosarase unha notificación e/ou enviarase por correo electrónico\n* 🔎 Traballo en segundo plano para escanear todos os ficheiros\n\nEste aplicativo inspecciona os ficheiros que se envía ao Nextcloud na busca de virus antes de que estean escritos no almacenamento do Nextcloud. Se un ficheiro é identificado como un virus, rexistrase e non se envía ao servidor. O aplicativo baséase no motor de exploración de virus ClamAV subxacente, ao que o administrador apunta o Nextcloud ao configurar o aplicativo.\nPara que este aplicativo sexa efectivo, as definicións do virus ClamAV deberían estar actualizadas. Teña en conta tamén que activar este aplicativo afectará ao rendemento do sistema xa que se require un procesamento adicional para cada envío. Atopará máis información dispoñíbel na documentación do Antivirus.",
    ...
    "Background scan file size limit in bytes, -1 means no limit" : "Límite de tamaño de ficheiro de escaneo de segundo plano en bytes, -1 significa sen límite",
