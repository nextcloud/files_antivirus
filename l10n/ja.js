OC.L10N.register(
    ...
    "Failed to save rule" : "ルールの保存に失敗しました",
    "Rule deleted" : "ルールを削除しました",
    "Failed to delete rule" : "ルールの削除に失敗しました",
    "All rules cleared" : "全てのルールがクリアされました",
    "Failed to clear rules" : "ルールのクリアに失敗しました",
    "Rules reset to defaults" : "ルールがデフォルト設定にリセットされました",
    "Failed to reset rules" : "ルールのリセットに失敗しました",
    ...
    "Extra command line options" : "追加のコマンドラインオプション",
    ...
    "Streaming options" : "ストリーミングのオプション",
    "File size limit" : "ファイルサイズの制限",
    "File size limit for periodic background scans and chunked uploads in bytes, -1 means no limit" : "定期的なバックグラウンドスキャンおよびチャンクアップロードのバイト単位のファイルサイズ制限。-1は制限なしを意味します",
    "First bytes to scan" : "最初にスキャンするバイト",
    "Check only first bytes of the file, -1 means no limit" : "ファイルの最初のバイトのみをチェックします。-1は制限なしを意味します",
    "Maximum stream length" : "ストリームの最大長",
    "Reopen socket after this number of bytes." : "このバイト数に達したらソケットを再開する。",
    "Infected file handling" : "感染ファイルの取り扱い",
