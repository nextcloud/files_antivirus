OC.L10N.register(
    ...
    "%s. Upload cannot be completed." : "%s. Ładowanie nie może być ukończone.",
    "Saved" : "Zapisano",
    "Antivirus for files" : "Antywirus dla plików",
    "An antivirus app for Nextcloud" : "Aplikacja antywirusowa dla Nextcloud",
    "Antivirus for files is an antivirus app for Nextcloud.\n\n* 🕵️‍♂️ When the user uploads a file, it's checked\n* ☢️ Uploaded and infected files will be deleted and a notification will be shown and/or sent via email\n* 🔎 Background Job to scan all files\n* ❓ Use ClamAV (open source), Kaspersky Scan Engine or an ICAP compatible scanner\n\nThis application inspects files that are uploaded to Nextcloud for viruses before they are written to the Nextcloud storage. If a file is identified as a virus, it is either logged or not uploaded to the server. The application relies on the underlying ClamAV virus scanning engine, which the admin points Nextcloud to when configuring the application. Alternatively, a Kaspersky Scan Engine can be configured, which has to run on a separate server.\nFor this app to be effective, the ClamAV virus definitions should be kept up to date. Also note that enabling this app will impact system performance as additional processing is required for every upload. More information is available in the Antivirus documentation." : "Antywirus dla plików to aplikacja antywirusowa dla Nextcloud.\n\n* 🕵️‍♂️ Kiedy użytkownik przesyła plik, jest on sprawdzany.\n* ☢️ Przesłane i zainfekowane pliki zostaną usunięte, a powiadomienie zostanie wyświetlone i/lub wysłane e-mailem.\n* 🔎Zadanie w tle do skanowania wszystkich plików.\n* ❓Można użyć ClamAV (open source), Kaspersky Scan Engine lub skanera zgodnego z ICAP.\n\nTa aplikacja sprawdza pliki przesyłane do Nextcloud w poszukiwaniu wirusów, zanim zostaną zapisane w pamięci Nextcloud. Jeśli plik zostanie zidentyfikowany jako wirus, jest on rejestrowany lub nie przesyłany na serwer. Aplikacja opiera się na silniku skanującym ClamAV, do którego administrator wskazuje Nextcloud podczas konfigurowania aplikacji. Alternatywnie można skonfigurować Kaspersky Scan Engine, który musi działać na osobnym serwerze.\nAby było to skuteczne, definicje wirusów ClamAV muszą być aktualizowane. Należy również zauważyć, że włączenie tej aplikacji wpłynie na wydajność systemu, ponieważ każde przesłanie pliku wymaga dodatkowego przetwarzania. Więcej informacji można znaleźć w dokumentacji Antywirusa.",
    ...
    "TLS" : "TLS",
    "Use TLS encryption." : "Użyj szyfrowania TLS.",
    ...
    "Check only first bytes of the file, -1 means no limit" : "Sprawdź tylko pierwsze bajty pliku, -1 oznacza brak limitu",
    ...
    "Block uploads when scanner is not reachable" : "Blokuj przesyłanie, gdy skaner jest niedostępny",
    "Yes" : "Tak",
    "No" : "Nie",
    "Block unscannable files (such as encrypted archives)" : "Blokuj nieskanowalne pliki (takie jak zaszyfrowane archiwa)",
    "Save" : "Zapisz",
