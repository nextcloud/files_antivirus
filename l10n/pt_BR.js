OC.L10N.register(
    ...
    "All rules cleared" : "Todas as regras apagadas",
    "Failed to clear rules" : "Falha ao apagar a regra",
    "Rules reset to defaults" : "Regras redefinidas ao padrão",
    ...
    "Signature to search" : "Assinatura a ser pesquisada",
    ...
    "Extra command line options" : "Opções adicionais da linha de comando",
    ...
    "Host" : "Hospedeiro",
    "Address of Antivirus Host." : "Endereço do hospedeiro do antivírus.",
    "Port" : "Porta",
    "Port number of Antivirus Host." : "Número da porta do hospedeiro do antivírus.",
    "ICAP preset" : "Predefinição ICAP",
    "Select" : "Selecione",
    "ICAP mode" : "Modo ICAP",
    "ICAP service" : "Serviço ICAP",
    "ICAP virus response header" : "Cabeçalho de resposta de vírus ICAP",
    "Use TLS encryption." : "Usar criptografia TLS.",
    "Streaming options" : "Opções de fluxos",
    "File size limit" : "Limite do tamanho de arquivo",
    "File size limit for periodic background scans and chunked uploads in bytes, -1 means no limit" : "Limite de tamanho de arquivo para varreduras periódicas em segundo plano e uploads em partes, em bytes; -1 significa sem limite",
    "First bytes to scan" : "Primeiros bytes a serem verificados",
    "Check only first bytes of the file, -1 means no limit" : "Verificar apenas os primeiros bytes do arquivo, -1 significa sem limite",
    "Maximum stream length" : "Comprimento máximo do fluxo",
    "Reopen socket after this number of bytes." : "Reabrir o soquete após esse número de bytes.",
    "Infected file handling" : "Tratamento de arquivos infectados",
    "When infected files are found during a background scan" : "Quando vírus são encontrados num escaneamento em retaguarda",
    "Block uploads when scanner is not reachable" : "Bloquear uploads quando o scanner não estiver acessível",
